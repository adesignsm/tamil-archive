...
useEffect(() => {
    const handleMovement = () => {
        ...
        return function updateMovement() {
          ...
          const maxPosZ = 100; // Maximum allowed Z position
          ...
          if (controlsRef.current) {
            ...
            if (moveForward.current || moveBackward.current || moveLeft.current || moveRight.current) {
              ...
              controlsRef.current.getObject().position.set(
                newPositionX,
                currentPosition.y, // Retain current Y position to restrict vertical movement
                newPositionZ
              );
            }
          }
  ...
  return (
    <div>
      <Suspense>
        <Canvas
          frameloop="always"
          camera={{ fov: 60, near: 0.1, far: 100000, position: [0, 15, 100] }}
        >
